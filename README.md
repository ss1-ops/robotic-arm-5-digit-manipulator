...
│   ├── ros/                           # ROS 2 nodes, publishers, launchers
│   └── vision/                        # Stereo calibration, hand-eye, IBVS, object approach
├── gripper/
│   └── aero-hand-open/                # Full Aero Hand Open (tendon-driven EE)
│       ├── firmware/, hardware/ (CAD+PCB), ros2/, sdk/, ...
├── reference/
│   └── bcn3d-moveo/                   # Original open-source BCN3D Moveo mechanical files (parts 1+2)
