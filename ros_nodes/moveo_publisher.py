...
# Link lengths in METRES — from the CAD URDF (moveo_clean.urdf) joint-to-joint
...
_L_WRIST = 0.053   # wrist-roll (J4) to wrist-pitch (J5) pivot
_L_EE    = 0.040   # wrist-pitch (J5) to end-effector / tool tip
